...
namespace Api.Controllers
{
    ...
    public class InfectadoController : ControllerBase
    {
        ...
        {
            var infectado = new Infectado(dto.DataNascimento, dto.Sexo, dto.Profissao, dto.Latitude, dto.Longitude);

            _infectadosCollection.InsertOne(infectado);
            
            return StatusCode(201, "Infectado adicionado com sucesso, parabéns!");
        }
